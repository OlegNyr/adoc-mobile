...
class CorpusComparisonTest {
    ...
    private val knownDeviations = mapOf(
        "10-macros-inline" to Known(
            reason = "асциидоктор#1870: pass:[…] экранирует содержимое вместо пропуска без подстановок",
            actualSha256 = "82fd2e9e81b5897355e316786287aa32255371c837cf98b7b4549459f591865f",
        ),
        "13-footnotes" to Known(
            reason = "асциидоктор#1871: сноски в списках и ячейках дублируют id, ссылки ведут не туда",
            actualSha256 = "5db43baa05a34b6e007a548da33b57a9da1b0e3a17fd10b68fab2d47458ef6ce",
        ),
        "18-substitutions" to Known(
            reason = "асциидоктор#1870: pass:[…] экранирует содержимое (второй файл с той же конструкцией)",
            actualSha256 = "8a8d9e888731ebd383e807c83b82ae51c0543d1f89138f1963e81bad791789c7",
        ),
