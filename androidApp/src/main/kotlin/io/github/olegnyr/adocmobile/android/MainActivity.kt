...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Диагностический вход для ручных кейсов 004 (TC-21, TC-27) — с SL-4
        // постоянное место этих проверок (требование интеграции спеки 005:
        // возможности временных поверхностей остаются доступными). Хуки, а не
        // debug-пункты меню, сознательно: проверки скриптуются из adb без
        // касаний, а меню продукта не носит отладочных пунктов даже за гейтом.
        // Только debug-сборка: в релизе интент игнорируется.
        runDebugDiagnostics()
